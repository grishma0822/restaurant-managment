 ...
 */
  ...
  function($uibModalStack ,  $q ,  $animate,   $injector) {
    var $animateCss = null;
  ...
  .factory('$uibModalStack', [
    ...
    function($animate ,  $timeout ,  $document ,  $compile ,  $rootScope ,
      ...
      $document.bind('keydown', function(evt) {
        ...
        if (modal && modal.value.keyboard) {
          switch (evt.which){
            ...
            case 9: {
              $uibModalStack.loadFocusElementList(modal);
              var focusChanged = false;
              if (evt.shiftKey) {
                if ($uibModalStack.isFocusInFirstItem(evt)) {
                  focusChanged = $uibModalStack.focusLastFocusableElement();
                }
              } else {
                if ($uibModalStack.isFocusInLastItem(evt)) {
                  focusChanged = $uibModalStack.focusFirstFocusableElement();
                }
              }
      ...
      $uibModalStack.focusFirstFocusableElement = function() {
      ...
      $uibModalStack.focusLastFocusableElement = function() {
        if (focusableElementList.length > 0) {
      ...
      $uibModalStack.isFocusInFirstItem = function(evt) {
        if (focusableElementList.length > 0) {
      ...
      $uibModalStack.isFocusInLastItem = function(evt) {
        if (focusableElementList.length > 0) {
      ...
      $uibModalStack.clearFocusListCache = function() {
  ...
  .provider('$uibModal', function() {
    var $uibModalProvider = {
      ...
      $get: ['$injector', '$rootScope', '$q', '$templateRequest', '$controller', '$uibModalStack',
        function ($injector, $rootScope, $q, $templateRequest, $controller, $uibModalStack) {
          var $uibModal = {};
